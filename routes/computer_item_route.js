...
router.get("/get-computer-item", get_computer_item_controller);
router.get("/single-computer-item/:slug", single_computer_item_controller);
router.get("/product-photo/:id", computer_item_photo_controller);
router.put("/update-computer-item/:id", put_computer_item_controller);
